  ...
  return (
    <Layout>
      <div className="max-w-md">
        <h1 className="text-xl font-semibold text-ink-100 mb-6">Profile</h1>
        ...
        <div className="card p-6">
          ...
          <div className="flex items-center gap-4 mb-6 pb-6 border-b border-ink-800">
            ...
            <div>
              ...
              {user?.isVerified && (
                <span className="badge bg-success/10 text-success border border-success/20 mt-1">✓ Verified</span>
              )}
            </div>
          </div>

          {success && <div className="bg-success/10 border border-success/20 text-success text-sm px-3 py-2 rounded-lg mb-4">Profile updated!</div>}
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <button type="submit" className="btn-primary flex justify-center" disabled={saving}>
