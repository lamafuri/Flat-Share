      ...
      <div className="card p-6 w-full max-w-lg mb-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
                ...
                <div key={idx} className="flex gap-2 items-start">
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      ...
                      {COMMON_ITEMS.map(ci => <option key={ci} value={ci}>{ci}</option>)}
                    </select>
                    {item.itemName === 'Other' && (
                      <input
                        type="text"
            ...
            <button type="button" onClick={addRow} className="mt-3 text-sm text-accent hover:text-accent-light flex items-center gap-1 transition-colors">
